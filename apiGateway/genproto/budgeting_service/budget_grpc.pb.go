...
type BudgetServiceClient interface {
	...
	DeleteBudget(ctx context.Context, in *PrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *budgetServiceClient) DeleteBudget(ctx context.Context, in *PrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type BudgetServiceServer interface {
	...
	DeleteBudget(context.Context, *PrimaryKey) (*empty.Empty, error)
...
func (UnimplementedBudgetServiceServer) DeleteBudget(context.Context, *PrimaryKey) (*empty.Empty, error) {
